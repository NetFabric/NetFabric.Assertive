...
namespace NetFabric.Assertive.UnitTests
{
    public partial class NullableReferenceTypeAssertionsTests
    {
        ...
        public void BeAsyncEnumerable_With_MissingGetEnumerator_Should_Throw()
        {
            ...
            Assert.Equal($"Expected to be an async enumerable but it's missing a valid 'GetAsyncEnumerator' method.{Environment.NewLine}Actual: NetFabric.Assertive.UnitTests.NullableReferenceTypeAssertionsTests+MissingGetAsyncEnumeratorAsyncEnumerable`1[System.Int32]", exception.Message);
        }
        ...
        public void BeAsyncEnumerable_With_MissingCurrent_Should_Throw()
        {
            ...
            Assert.Equal(actual, exception.Actual);
            Assert.Equal($"Expected to be an async enumerator but it's missing a valid 'Current' property.{Environment.NewLine}Actual: NetFabric.Assertive.UnitTests.NullableReferenceTypeAssertionsTests+MissingCurrentAsyncEnumerable`1[System.Int32]", exception.Message);
        }
        ...
        public void BeAsyncEnumerable_With_MissingMoveNext_Should_Throw()
        {
            ...
            Assert.Equal(actual, exception.Actual);
            Assert.Equal($"Expected to be an async enumerator but it's missing a valid 'MoveNextAsync' method.{Environment.NewLine}Actual: NetFabric.Assertive.UnitTests.NullableReferenceTypeAssertionsTests+MissingMoveNextAsyncAsyncEnumerable`1[System.Int32]", exception.Message);
        }
